...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        _contentLab.textColor = UIColorFromRGB(0x999999);
        ...
        _pasteBtn.titleLabel.font = kFontWithSize(13);
        _pasteBtn.layer.borderColor = UIColorFromRGB(0x999999).CGColor;
        [_pasteBtn setTitleColor:UIColorFromRGB(0x626262) forState:UIControlStateNormal];
