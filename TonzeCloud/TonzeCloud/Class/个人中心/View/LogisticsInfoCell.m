...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        self.backgroundColor = UIColorFromRGB(0x3AE18D);;
        ...
        _goodsNumLab.font = kFontWithSize(12);
        ...
        _logisticsCompanyLab.font = kFontWithSize(13);
        ...
        _logisticsSingleNumberLab.font = kFontWithSize(13);
        ...
        _logisticsCallLab.font = kFontWithSize(13);
