...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        _personInfoLab.textColor = UIColorFromRGB(0x313131);
        _personInfoLab.font = kFontWithSize(15);
        ...
        _addressInfoLab.textColor = UIColorFromRGB(0x636363);
        _addressInfoLab.font = kFontWithSize(15);
        ...
        _defaultBtn.titleLabel.font = kFontWithSize(15);
        [_defaultBtn setTitle:@"默认地址" forState:UIControlStateNormal];
        [_defaultBtn setImage:[UIImage imageNamed:@"ic_pub_choose_nor"] forState:UIControlStateNormal];
        [_defaultBtn setTitleColor:UIColorFromRGB(0x313131) forState:UIControlStateNormal];
        ...
        _editorBtn.titleLabel.font = kFontWithSize(15);
        [_editorBtn setTitle:@"编辑" forState:UIControlStateNormal];
        [_editorBtn setTitleColor:UIColorFromRGB(0x313131) forState:UIControlStateNormal];
        ...
        _deleteBtn.titleLabel.font = kFontWithSize(15);
        [_deleteBtn setTitle:@"删除" forState:UIControlStateNormal];
        [_deleteBtn setTitleColor:UIColorFromRGB(0x313131) forState:UIControlStateNormal];
...
- (void)cellWithModel:(ShippingAddressModel *)addressModel{
    ...
    if ([addressModel.is_default isEqualToString:@"true"] ) {
        ...
        [_defaultBtn setImage:[UIImage imageNamed:@"ic_pub_choose_sel"] forState:UIControlStateNormal];
    }else{
