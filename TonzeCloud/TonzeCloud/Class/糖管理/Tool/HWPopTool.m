...
- (void)showWithPresentView:(UIView *)presentView animated:(BOOL)animated {
    ...
    if(self.closeButtonType == ButtonPositionTypeRight){
        ...
        closeFrame.origin.x = CGRectGetWidth(containerView.bounds)-CGRectGetWidth(closeFrame)- (kScreenWidth-80)/2;
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    ...
    if ([HWPopTool sharedInstance].tapOutsideToDismiss) {
        ...
        [[NSNotificationCenter defaultCenter]postNotificationName:kAnnouncementClickNotify object:nil];
    }
