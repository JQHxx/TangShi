...
-(void)viewWillAppear:(BOOL)animated{
    ...
    if ([TCHelper sharedTCHelper].isAddressSelectedReload) {
        [allAddressArray removeAllObjects];
        [self requestConsigneeAddressInfo];
        [TCHelper sharedTCHelper].isAddressSelectedReload=NO;
...
-(UITableView *)addressTableView{
    if (!_addressTableView) {
        _addressTableView=[[UITableView alloc] initWithFrame:CGRectMake(0, kNavHeight+20, kScreenWidth, kRootViewHeight-45) style:UITableViewStylePlain];
