...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        [selectBtn setImage:[UIImage imageNamed:@"ic_pub_choose_nor"] forState:UIControlStateNormal];
        [selectBtn setImage:[UIImage imageNamed:@"ic_pub_choose_sel"] forState:UIControlStateSelected];
...
-(void)cartTableViewCellDisplayWithModel:(CartGoodsModel *)goodsModel isCart:(BOOL)isCart{
    ...
    if (isCart) {
        ...
        priceLabel.frame=CGRectMake(goodsImageView.right+10, goodsSpecLabel.bottom+10, 120, 20);
    }
