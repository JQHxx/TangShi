...
-(void)txhRrettyRuler:(TXHRulerScrollView *)rulerScrollView index:(NSInteger)index{
    heightValue=rulerScrollView.rulerValue+30;
...
- (void)initHeightView{
    ...
    UIImageView *personImg = [[UIImageView alloc] initWithFrame:CGRectMake((kScreenWidth-80)/2,44+60, 80, 80)];
