...
- (CGFloat)setupPicUrlArray:(NSArray *)picUrlArray{
    ...
    for (int i = 0; i< _picUrlArray.count; i++) {
        ...
        imageView.hidden = NO;
        [imageView sd_setImageWithURL:obj placeholderImage:[UIImage imageNamed:@"dynamicLoading_icon"]  completed:^(UIImage *image, NSError *error, EMSDImageCacheType cacheType, NSURL *imageURL) {
